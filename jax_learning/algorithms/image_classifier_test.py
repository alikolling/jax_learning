...
from jax_learning.algorithms.testsuites.lightning_module_tests import LightningModuleTests
from jax_learning.configs import Config
...
from jax_learning.main_test import experiment_commands_to_test
...
class TestImageClassifier(LightningModuleTests[ImageClassifier]):
    ...
    - `algorithm_config` will take the value `"image_classifier"`
        - This is because there is an `image_classifier.yaml` config file in jax_learning/configs/algorithms
