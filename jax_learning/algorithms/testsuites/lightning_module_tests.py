...
See the [jax_learning.algorithms.image_classifier_test][] module for an example of how to use this.
"""
...
from jax_learning.conftest import DEFAULT_SEED
from jax_learning.experiment import instantiate_trainer
from jax_learning.main import instantiate_algorithm, setup_logging
...
class LightningModuleTests(Generic[LightningModuleType], ABC):
    ...
    See the [jax_learning.algorithms.image_classifier_test][] module for an example.
