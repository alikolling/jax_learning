...
class Config:
    ...
    For more info, see the [instantiate_algorithm][jax_learning.main.instantiate_algorithm] function.
    """
    ...
    See the [MNISTDataModule][jax_learning.datamodules.image_classification.mnist.MNISTDataModule] for an example.
    """
