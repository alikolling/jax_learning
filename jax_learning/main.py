...
import jax_learning
from jax_learning.configs import add_configs_to_hydra_store
from jax_learning.configs.config import Config
from jax_learning.experiment import evaluate, instantiate_datamodule, instantiate_trainer, train
from jax_learning.utils.hydra_utils import resolve_dictconfig
from jax_learning.utils.utils import print_config

if typing.TYPE_CHECKING:
    from jax_learning.trainers.jax_trainer import JaxModule

PROJECT_NAME = jax_learning.__name__
...
def setup_logging(log_level: str, global_log_level: str = "WARNING") -> None:
    from jax_learning.main import PROJECT_NAME
    ...
    jax_learning_logger = logging.getLogger(PROJECT_NAME)
    jax_learning_logger.setLevel(log_level.upper())
