...
# Use monkeypatch.setattr(jax_learning.utils.remote_launcher_plugin, ..., that_mock)
...
import jax_learning.utils.remote_launcher_plugin
from jax_learning.main import PROJECT_NAME, main
from jax_learning.main_test import CONFIG_DIR
from jax_learning.utils import remote_launcher_plugin
from jax_learning.utils.env_vars import SLURM_JOB_ID
from jax_learning.utils.remote_launcher_plugin import RemoteSlurmLauncher
from jax_learning.utils.testutils import IN_GITHUB_CI, IN_SELF_HOSTED_GITHUB_CI
...
def test_run_remote_job(argv: list[str], monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr(
        jax_learning.utils.remote_launcher_plugin, RemoteSlurmLauncher.__name__, launcher_mock
    )

    monkeypatch.setattr(sys, "argv", ["jax_learning/main.py"] + argv)
