...
from jax_learning.utils.env_vars import NETWORK_DATASETS_DIR, SLURM_JOB_ID
from jax_learning.utils.hydra_utils import get_outer_class
...
def get_target_of_config(
    ...
    if _cs is None:
        from jax_learning.configs import cs as _cs
